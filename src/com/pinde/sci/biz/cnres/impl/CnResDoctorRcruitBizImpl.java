...
public class CnResDoctorRcruitBizImpl implements ICnResDoctorRecruitBiz{
...
//	}
	...
	public void setDoctorConfirmFlagForOutOfDate(String year, String doctorFlow) {
		...
		if(currDate.compareTo(admitEndDate)>0){
			ResDoctorRecruit record = new ResDoctorRecruit();
			record.setConfirmFlag(GlobalConstant.FLAG_F);//学员过期标记
			ResDoctorRecruitExample example = new ResDoctorRecruitExample();
			...
			this.doctorRecruitMapper.updateByExample(record , example);
		}
