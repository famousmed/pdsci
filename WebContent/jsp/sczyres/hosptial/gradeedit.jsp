	...
	<form id="gradeForm" style="position: relative;">
	    <table border="0" width="100%">
		    <tr>
		        ...
		        <td>
		            <input type="text" class="input validate[custom[positiveNum]]" name="examResult" value="${recruit.examResult}"/>
		        </td>
		    </tr>
		    <tr>
		        <td align="right" height="50px"><label>面试成绩：</label></td>
		        <td><input type="text" class="input validate[custom[positiveNum]]" name="auditionResult" value="${recruit.auditionResult}"/></td>
		    </tr>
		    <tr>
		        <td align="right"><label>技能成绩：</label></td>
		        <td><input type="text" class="input validate[custom[positiveNum]]" name="operResult" value="${recruit.operResult}"/></td>
		    </tr>
		</table>
