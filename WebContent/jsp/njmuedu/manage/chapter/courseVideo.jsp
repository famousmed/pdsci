...
<div class="videoPage cbody clearfix video-sig">
   ...
   <div class="videoBox">
        <div class="videobg">
  		 ...
  		 <div class="video-des" <c:if test="${sysCfgMap['njmuedu_player_control']==GlobalConstant.FLAG_Y}">style="display:none;"</c:if>>
            <ul class="fl">
...
<!--/content-->
<div id="footer">技术支持：南京品德信息技术有限公司<br />Copyright © 2001- 2015 Character Technology, Inc. All rights reserved.</div>
</div>
</body>
</html>