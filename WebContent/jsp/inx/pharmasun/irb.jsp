...
<title>法默生伦理审查管理系统 | pharmasun-ERM</title>
...
<style>
.irb{background: #EAEAEA url(<s:url value='/css/img/bgirb.jpg' />) no-repeat top center;}
</style>
</head>
<body class="irb" >
<div class="m">
<div class="bg">
<div class="bgt"><font color="#FFFFFF">伦理审查管理系统</font></div>
<div class="bgform">
