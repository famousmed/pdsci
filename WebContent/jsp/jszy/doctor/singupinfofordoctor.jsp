...
$(function(){
	$("#toptab li").click(function(){
		...
		if($(this).attr("id")=="swap"){
			jboxLoad("singupinfo" , "<s:url value='/jszy/doctor/swap'/>" , true);
		}
...
function print(userFlow){
	jboxTip("打印中,请稍等...");
	var url = '<s:url value="/jszy/doctor/print"/>?userFlow=' + userFlow;
	window.location.href = url;
}

function printAdmissionCard(userFlow){
	jboxTip("打印中,请稍等...");
	var url = '<s:url value="/jszy/doctor/printAdmissionCard"/>?userFlow=' + userFlow;
	window.location.href = url;
}
</script>
<div class="main_hd">
     <h2>
     	...
     	<c:if test="${regStatusEnumPassed.id eq doctor.doctorStatusId and sczyRecDocTypeEnumAgency.id != doctor.doctorTypeId and doctor.orgFlow eq 'f804202731d940de95159619e96e22bf'}">
    ...
    <div class="title_tab" id="toptab">
        <ul>
            ...
            <!-- <li class="tab" id='swap'><a>志愿调剂</a></li> -->
        </ul>
    </div>
</div>
<div id="singupinfo">
<jsp:include page='/jsp/jszy/doctor/singupinfo.jsp'/>
