...
<script type="text/javascript">
	...
	function showMsg(orgFlow) {
		var url = "<s:url value='/jszy/manage/showDocRecruit'/>?orgFlow="+orgFlow;
	...
	function planInfo(orgFlow) {
		...
		jboxPostLoad("content","<s:url value='/jszy/manage/planInfo'/>?source=${param.source}",data,true);
	}
</script>
      <div class="main_hd">
        <h2>
          ...
          <table border="0" cellpadding="0" cellspacing="0" class="grid">
            ...
            <c:if test="${GlobalConstant.USER_LIST_LOCAL !=param.source or org.orgFlow eq param.orgFlow }">
            	<tr>
            		...
            		<td style="text-align: left;padding-left: 20px;width: ">${org.orgName}</td>
