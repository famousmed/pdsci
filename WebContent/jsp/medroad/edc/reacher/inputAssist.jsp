...
function showContent(contentid,id,url){
				...
				<div class="faqscene_tabs">
					<div class="faqscene_tab_hd">
						<ul class="js_faq_class1">
							...
							<li data-report-id="233"><a id="id1" class="active"
								href="javascript:showContent('233','id1','');">填写说明</a></li>

							<li data-report-id="234"><a id="id2"  href="javascript:showContent('234','id2','');">快速定位</a></li>

							<li data-report-id="235"><a id="id3" href="javascript:showContent('235','id3','<s:url value='/medroad/dataevent'/>');">数据澄清</a></li>

							<li data-report-id="236"><a id="id4" href="javascript:showContent('236','id4','<s:url value='/medroad/datainputlog'/>');">操作日志</a></li>

							<li data-report-id="237"><a id="id5" href="javascript:;" class="to_top">返回顶部</a></li>
