...
function savePatient(){
	...
	jboxPost("<s:url value='/medroad/savePatient'/>",$("#patientForm").serialize(),function(resp){
		jboxTip(resp);
		patients('${sessionScope.currUser.orgFlow }','');
	},null);
}
			...
			<tbody>
			    ...
			    <tr>
			        ...
			        <td><input name="patientPhone"  class="validate[required,custom[mobile]] input" style="width:250px;"/><span style="color: red;">*</span></td>
		       		<th>家属联系电话：</th>
			    	<td colspan="2"><input name="patientRelationPhone"  class="input"  style="width:250px;"/>&#12288;</td>	        
			    </tr>
			    <tr>
			    	<th>家庭地址：</th>
			    ...
			    <tr>
			    	<th>备注：</th>
			        <td colspan="4"><textarea name="patientStageNote" placeholder="主诉、诊断、既往史、过敏史、病情介绍等" class="input" style="height: 100px;width: 560px;margin-top: 5px;margin-bottom: 5px;text-indent:0"></textarea></td>
			    </tr>
			 </tbody>
		</table>
	</div>
