  ...
  <meta charset="UTF-8" />
    <link rel="stylesheet" type="text/css" 	href="<s:url value='/jsp/medroad/css/bootstrap.min.css'/>"></link>
  <link rel="stylesheet" type="text/css" 	href="<s:url value='/jsp/medroad/css/daterangepicker.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
  <script type="text/javascript" src="<s:url value='/jsp/medroad/js/moment.js'/>"></script>
  <script type="text/javascript" src="<s:url value='/jsp/medroad/js/daterangepicker.js'/>"></script>


	&#12288;&#12288;访视日期：<span
					class="frm_input_box" style="width:150px;">
						<input  type="text" placeholder="" id="visitDate" name="visitDate";
	...
	&#12288;&#12288;下次随访日期：
				<span
					class="frm_input_box" style="width: 250px;"> 
						<input  type="text" placeholder="" readonly="readonly" name="visitWindow";
						class="frm_input js_option_input frm_msg_content validate[required]" id="visitWindow"
						 value=""
					autocomplete="off">
					</span>
					<!-- 
					<span>&#12288;可据节假日或特殊情况自行调整</span>
					 -->
