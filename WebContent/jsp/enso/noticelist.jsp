...
function toPage(page) {
	...
	jboxLoad("content","<s:url value='/enso/noticelist'/>?currentPage="+currentPage,false);
} 
...
<div class="content_main">
 <div class="index_form" style="margin-bottom: 10px;">
          ...
          <c:forEach items="${infos}" var="msg">
            <li>
            <strong><a href="<s:url value='/enso/noticeview'/>?infoFlow=${msg.infoFlow}" target="_blank">${msg.infoTitle}</a><i class="new"></i></strong>
