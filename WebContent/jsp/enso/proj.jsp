			...
			<div class="yw">
				<div class="head">
					<div class="head_inner">
						<h1 class="logo">
							<a href="javascript:refresh();">${applicationScope.sysCfgMap['sys_title_name']}</a>
						</h1>
						<div class="account">
							<h2 style="text-align: right">${sessionScope.currUser.userName
								}&#12288;-&#12288;${sessionScope.currUser.orgName }</h2>
							<div class="head_right">
								<a href="javascript:refresh();">项目列表</a> <a
									href="<s:url value='/logout'/>">退出</a>
							</div>
						</div>
					</div>
				</div>
