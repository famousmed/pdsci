		...
		<div class="infoAudit">
			<div style="width: 90%;margin-right: auto;margin-left: auto;">
	 		...
	 		<form id="summaryForm" method="post">
					...
					<tr class="orgTr">
						<td class="orgTd" colspan="4" style="padding-top:10px;padding-left:0;">
							<c:if test="${empty rec && param.roleFlag eq GlobalConstant.RES_ROLE_SCOPE_DOCTOR}">
								<textarea name="personalSummary" class="validate[required]"></textarea>
							</c:if>
							<c:if test="${empty rec && !(param.roleFlag eq GlobalConstant.RES_ROLE_SCOPE_DOCTOR)}">
								暂无出科小结!
							</c:if>
				...
				<c:if test="${!empty rec}">
				<table class="orgTable" border="0" width="90%" cellspacing="0" cellpadding="0" style="margin-left: auto;margin-right: auto;">
					<caption class="orgCaption">科室评价</caption>
					<tr class="orgTr">
						<td class="orgTd" colspan="4" style="padding-top:10px;padding-left:0;">
				...
				<table class="orgTable" border="0" width="90%" cellspacing="0" cellpadding="0" style="margin-left: auto;margin-right: auto;">
					<caption class="orgCaption">
						科主任签名&#12288;
						<label style="font-weight: normal;color: black;">
							<input type="checkbox" name="isAgaree" 
							value="${GlobalConstant.FLAG_Y}" 
							<c:if test="${(empty formDataMap['deptHeadAutograth'] && param.roleFlag eq GlobalConstant.RES_ROLE_SCOPE_HEAD) || (formDataMap['isAgaree'] eq GlobalConstant.FLAG_Y)}">
								checked
							</c:if>
	         	...
	         	<div style="text-align: center;margin-top: 5px;width: 90%;margin-left: auto;margin-right: auto;">
			         ...
			         <c:if test="${!empty param.roleFlag && !(param.roleFlag eq GlobalConstant.RES_ROLE_SCOPE_DOCTOR)}">
			         	<c:if test="${!empty rec && ((empty formDataMap['deptAppraise'] && param.roleFlag eq GlobalConstant.RES_ROLE_SCOPE_TEACHER) || (empty formDataMap['deptHeadAutograth'] && param.roleFlag eq GlobalConstant.RES_ROLE_SCOPE_HEAD))}">
