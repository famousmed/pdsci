...
<script type="text/javascript">
	function saveForm(){
		if(!$.trim($("#inputMain").val())){
			return jboxTip("请填写病种名称！");
		}
	...
	$(function(){
		...
		<c:if test="${rec.auditStatusId eq recStatusEnumTeacherAuditY.id || !(param.roleFlag eq GlobalConstant.RES_ROLE_SCOPE_DOCTOR) || param.isRead}">
			$("#diseaseForm :input:not(:hidden,:button)").each(function(){
   		...
   		<table class="basic" width="100%">
             ...
             <tr>
              ...
              <tr>
                ...
                <td >
                   <label><input name="recStatus" type="checkbox" value="主管" ${(fn:indexOf(formDataMap['recStatus'],'主管')>-1)?'checked="true"':''}/>是否主管</label>
                   &#12288;
                   <label><input name="recStatus" type="checkbox" value="抢救" ${(fn:indexOf(formDataMap['recStatus'],'抢救')>-1)?'checked="true"':''}/>是否抢救</label>
				</td>
                ...
                <td colspan="3">
                    	<label><input type="checkbox" name="caseType" value="新收病人" ${(fn:indexOf(formDataMap['caseType'],'新收病人')>-1)?'checked="true"':''}/>新收病人</label>
                    	&#12288;
                    	<label><input type="checkbox" name="caseType" value="书写规范住院大病历" ${(fn:indexOf(formDataMap['caseType'],'书写规范住院大病历')>-1)?'checked="true"':''}/>书写规范住院大病历</label>
                    	&#12288;
                    	<label><input type="checkbox" name="caseType" value="学习病历" ${(fn:indexOf(formDataMap['caseType'],'学习病历')>-1)?'checked="true"':''}/>学习病历</label>
				</td>
             	</tr>
             	<tr>
