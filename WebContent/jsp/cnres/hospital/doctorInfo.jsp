	...
	<div class="infoAudit" >
		...
		<c:if test="${GlobalConstant.FLAG_Y eq recruit.recruitFlag}">
		 ...
		 <div>
		     ...
		     <span class="fr">
		     <a title="收缩" id="up" onclick=""><img src="<s:url value='/jsp/cnres/images/up.png'/>"/></a>
		     <a title="展开" id="down" onclick="" style="display: none"><img src="<s:url value='/jsp/cnres/images/down.png'/>"/></a>
             </span>
             </p>
