...
function addExamSite(){
	var url = "<s:url value='/cnres/singup/exam/addExamSite'/>";
	jboxOpen(url, "选择考点",500, 500);
}

function addColleges(recordFlow){
	var url = "<s:url value='/cnres/singup/exam/addColleges'/>?recordFlow=" + recordFlow;
...
<div class="main_hd">
  ...
  <span class="tips">当前考试：${sessionScope.currExam.examName}</span>
   ...
   <div class="title_tab" id="toptab">
    <ul>
      <li class="tab_select"><a href="javascript:void(0);" onclick="examSitePlan();">考点安排</a></li>
