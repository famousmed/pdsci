...
<link rel="stylesheet" type="text/css" href="<s:url value='/jsp/cnres/css/exam.css'/>?v=${applicationScope.sysCfgMap['sys_version']}"></link>
...
function chageExamSite(){
	...
	if(recordFlow){
		var url = "<s:url value='/cnres/singup/exam/getexamsite2'/>?recordFlow="+recordFlow;
		jboxStartLoading();
...
function addRoom(){
	jboxConfirm("确认添加考场？", function(){
		...
		var url = "<s:url value='/cnres/singup/exam/addroom'/>";
...
function changeSeatNum(obj , opt , roomFlow){
	...
	var url = "<s:url value='/cnres/singup/exam/updateseatnum'/>";
...
function changeSchimg(obj , seatNum){
	...
	if(seatNum==0){
		imgsrc = "<s:url value='/jsp/cnres/images/empty.png'/>";
	}else if(seatNum==sumUserCountInRoom){
		imgsrc = "<s:url value='/jsp/cnres/images/full.png'/>";
	}else if(seatNum>sumUserCountInRoom){
		imgsrc = "<s:url value='/jsp/cnres/images/free.png'/>";
	}
...
function showRoom(roomFlow){
	jboxLoad("content",'<s:url value="/cnres/singup/exam/showroom"/>?roomFlow='+roomFlow,true);
}
...
function smartAllotTicketnum(){
	jboxConfirm("确认分配？" , function(){
		var siteFlow = $('#siteCode').val();
		if(siteFlow){
			var url = "<s:url value='/cnres/singup/exam/smartallotticketnum'/>";
			jboxStartLoading();
...
<div class="main_hd">
    ...
    <div class="title_tab" id="toptab">
        <ul>
            <li class="tab"><a href="javascript:void(0);" onclick="examSitePlan();">考点安排</a></li>
            <li class="tab"><a href="javascript:void(0);" onclick="setExamUser();">人员分配</a></li>
            <li class="tab_select"><a>考场分配</a></li>
            <li class="tab"><a href="javascript:void(0);" onclick="examUser();">人员信息</a></li>
        	 <li class="tab"><a href="javascript:void(0);" onclick="examPrint();">考场打印</a></li>
        </ul>
    </div>
</div>
...
<div id="roomTmp" style="display: none;">
    <div class="sch">
		...
		<div class="sch_body">
		    <div class="sch_jd"><img alt="" src="<s:url value='/jsp/cnres/images/exam.png'/>"></div>
			<div class="sch_info">
