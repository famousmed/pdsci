    ...
    <div class="content">
	  ...
	  <form id="searchForm" action="<s:url value="/srm/ach/reseachrep/auditList/global"/>" method="post">
		 <p>
	 		...
	 		&#12288;提交时间：
	 		<input class="xltext ctime" style="width:158px;" type="text" name="submitDate" value="${param.submitDate}"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  readonly="readonly"/>
 		    &#12288;项目来源：
		...
		<p>	
            &#12288;主管部门：
           	<select id="chargeOrg" name="chargeOrgFlow" onchange="loadApplyOrg();" class="xlselect">
          			...
          			<option value="${chargeOrg.orgFlow}" <c:if test="${chargeOrg.orgFlow==param.chargeOrgFlow}">selected="selected"</c:if> >${chargeOrg.orgName}</option>
          			</c:forEach>
              </select>
            &#12288;申报单位：
