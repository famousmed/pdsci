...
<div class="content">
		<div class="title1 clearfix">
			<ul id="tags">
				<li class="selectTag"><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">项目信息</a></li>
				<li><a onclick="selectTag('tagContent1',this)" href="javascript:void(0)">项目进度及考核指标</a></li>
				<li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">项目承担单位、参加单位及主要研究开发人员</a></li>
				<li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">项目经费预算</a></li>
			</ul>
