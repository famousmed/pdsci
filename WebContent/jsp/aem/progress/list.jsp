...
<body>
	...
	<table class="xllist" > 
		<tr>
			...
			<th width="50px">动物</th>
			<th width="30px">数量</th>
			<th width="60px">计划开始时间</th>
			<th width="60px">计划结束时间</th>
			<th width="60px">实际开始时间</th>
			<th width="60px">实际结束时间</th>
		...
		<tr>			
			...
			<td>2014-06-05</td>
			<td>2014-06-05</td>
			<td><a href="<s:url value="/jsp/aem/progress/progress.jsp" />">查看进展</a></td>
		</tr>
		<tr>			
			<td></td>
			<td>***实验2</td>
